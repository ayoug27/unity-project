...
namespace BUT
{
    ...
    public class PlayerMovement : MonoBehaviour
    {
        ...
        [SerializeField] 
        AudioSource m_StepSoundSource;
        
        [SerializeField]
        ParticleSystem m_StepParticles;
        ...
        public bool IsMoving
        {
            set
            {
                ...
                m_StepSoundSource.enabled = value;
                if (m_IsMoving && m_IsGrounded) m_StepParticles.Play();
                else m_StepParticles.Stop();
            }
            get => m_IsMoving;
        }
        ...
        public bool IsGrounded
        {
            set
            {
                ...
                m_StepSoundSource.enabled = value;
                if (m_IsGrounded && m_IsMoving) m_StepParticles.Play();
                else m_StepParticles.Stop();
            }
            get => m_IsGrounded;
        }
